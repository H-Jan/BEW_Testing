...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        post_data = {
            'name': 'John Smith',
            'biography ': 'Wrote with words',
        }
        self.app.post('/create_author', data=post_data)
        

        # TODO: Verify that the author was updated in the database
        our_author = Author.query.filter_by(name = 'John Smith').one()
        self.assertIsNotNone(our_author)
    ...
    def test_create_genre(self):
        ...
        our_genre = Genre.query.filter_by(name = 'Science-Fiction').one()
        self.assertIsNotNone(our_genre)
        self.assertEqual(our_genre.name, 'Science-Fiction')
    ...
    def test_profile_page(self):
        ...
        our_response = response.get_data(as_text=True)
        self.assertIn('me1', our_response)
    ...
    def test_favorite_book(self):
        ...
        our_favorite = User.query.filter_by(username = 'me1').one()
        self.assertIsNotNone(our_favorite.favorite_books)
    ...
    def test_unfavorite_book(self):
        ...
        # favorites
        hello = User.query.filter_by(username = 'me1').one()
        self.assertEqual(hello.favorite_books, [])
